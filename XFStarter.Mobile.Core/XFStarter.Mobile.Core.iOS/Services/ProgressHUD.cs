...
namespace XFStarter.Mobile.Core.iOS.Services
{
    public class Ring
    {
        ...
        /// Background color
        /// </summary>
        public UIColor BackgroundColor = UIColor.LightGray;
        /// <summary>
    ...
    public class ProgressHUD : UIView
    {
        ...
        public void SetOSSpecificLookAndFeel()
        {
            ...
            HudStatusShadowColor = UIColor.LightGray;
            _ringThickness = 6f;
        }
        ...
        public UIColor HudBackgroundColour = UIColor.FromWhiteAlpha(1.0f, 0.4f);
        public UIColor HudForegroundColor = UIColor.White;
        public UIColor HudStatusShadowColor = UIColor.LightGray;
        ...
        public void ShowToast(string status, bool showToastCentered = false, double timeoutMs = 1000)
        {
            ShowToast(status, toastPosition: showToastCentered ? ToastPosition.Center : ToastPosition.Bottom, timeoutMs: timeoutMs);
        }
        ...
        public UIImage ErrorImage
        {
            get
            {
                return UIImage.FromBundle("error.png");
            }
        }
        ...
        public UIImage SuccessImage
        {
            get
            {
                return UIImage.FromBundle("success.png");
            }
        }
        ...
        void PositionHUD(NSNotification notification)
        {
            ...
            switch(toastPosition)
            {
                case ToastPosition.Bottom:
                    posY = activeHeight - textHeight - 30;
                    break;
